...
- Updated: 2026-09-18 by Kintsu
- Live release: `c9881d2`
- Public site: `https://solarisael.github.io/`
- Build: pass, 75 pages
- Tests: pass, 278 tests across 30 files
...
Each root inscription owns a depth region with depth `192` and padding `20`.
...
GitHub validation and Pages deployment passed for `c9881d2`.
See `history/2026-09-18.md` for the incident, rollback, repair, and exact proof.

## Open decisions

Terminal exterior art direction remains open.
Sol selected perimeter tracers as the next candidate.
Keep this work local until the rendered result earns approval.
